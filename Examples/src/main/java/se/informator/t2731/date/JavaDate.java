...
public final class JavaDate implements Comparable<JavaDate> {  //, java.io.Serializable{ 
	...
	public static void main(String[] args){
		JavaDate jd1 = new JavaDate(2000, 2, 29);
		System.out.println(jd1.toString() + " leap year: "+jd1.isLeapYear());

		JavaDate jd2 = new JavaDate(2010, 2, 29);
		System.out.println(jd2.toString() + " leap year: "+jd2.isLeapYear());
		
		JavaDate jd3 = new JavaDate(2011, 2, 29);
		System.out.println(jd3.toString() + " leap year: "+jd3.isLeapYear());
		
		JavaDate jd4 = new JavaDate(2100, 2, 29);
		System.out.println(jd4.toString() + " leap year: "+jd4.isLeapYear());
		
		JavaDate jd5 = new JavaDate(2400, 2, 29);
		System.out.println(jd5.toString() + " leap year: "+jd5.isLeapYear());
	}
